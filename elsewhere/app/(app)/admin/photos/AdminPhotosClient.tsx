  ...
  return (
    <div className="min-h-screen bg-surface p-16">
      <div className="mx-auto max-w-3xl">
        ...
        {placesQuery.isError && (
          <p role="alert" className="text-body-s text-status-low mt-16">
            Couldn&rsquo;t load places. Try refreshing.
          </p>
        )}
...
function PlacePhotoPicker({
  ...
  if (query.isError)
    return (
      <p role="alert" className="mt-12 text-ui-label-s text-status-low">
      ...
      {photos.map((photo) => {
        ...
        return (
          ...
          >
            <img
              src={photo.thumbUrl}
              alt={isSelected ? "Selected vibe photo" : "Photo option"}
