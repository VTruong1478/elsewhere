-- Return tables_none from get_feed_places for None/Limited/Ample tables level.
-- Drop first because return type (new column tables_none) cannot be changed with CREATE OR REPLACE.
