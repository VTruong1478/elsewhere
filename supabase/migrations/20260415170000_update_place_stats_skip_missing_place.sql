-- Avoid FK errors when bulk-deleting places: CASCADE removes a place while
-- rating DELETE triggers still fire; skip place_stats upsert if the place row is gone.
